...
const CAMERA_MOTION_PROMPTS = [
  ...
  },
  {
    ...
    prompt: "3-5 秒单镜头。黄昏山顶遗迹与远处云海构成宏大环境，一名穿深色长风衣的年轻女性站在圆形石台中央，左手握着带金属护角的旧地图筒，右手攥着一枚蓝色发光罗盘，衣摆和发丝被高空风吹向画面右侧。镜头从遗迹外数百米的高空超远景起幅，以稳定飞行姿态沿石阶轴线快速向前推进，先掠过断裂石柱和悬挂旗帜，再从人物正前方略高机位迅速逼近。推进过程中保持人物始终位于画面中心，速度先加速、接近人物前明显减速，景别由超远景连续过渡到全景、中景、近景，最终精准停在人物眼睛与上半张脸的特写；蓝色罗盘在下方前景短暂可见并形成冷光反射。人物站位、视线方向、地图筒和罗盘造型全程一致，空间轴线清楚，运动轨迹平滑，不穿模、不突然跳焦、不撞入人物脸部，不使用剪切转场，不要字幕，不要水印。",
  },
  {
    id: "dual-subject-shuttle",
    label: "双主体摆渡镜头",
    prompt: "4-6 秒单镜头。夜晚废弃车站月台，两名人物隔着一张长椅对峙：画面左侧是一名穿灰色风衣的年轻女性，右手握着银色录音笔；画面右侧是一名穿黑色夹克的中年男性，左手提着磨损的棕色公文包。镜头从女性肩后中近景起幅，先让她的肩线与录音笔占据前景，随后沿长椅边缘平稳横向摆渡到两人之间，短暂停在录音笔和公文包形成的道具关系上，再继续滑向男性肩后，最终以男性肩后过肩视角看向女性的近景落幅。摆渡过程中焦点从女性转移到两件道具，再转移到男性，始终保持两人站位、视线轴线和左右关系不变；运动速度前慢、中段略快、接近第二主体时再次减速。重点是通过摄影机在双主体之间往返传递权力关系和信息，不绕到轴线另一侧，不交换人物左右位置，不让道具消失，不突然切镜，不要字幕，不要水印。",
  },
  {
    id: "drone-low-fast-pass",
    label: "无人机低空快速拍摄",
    prompt: "3-5 秒单镜头。清晨荒漠公路穿过红色峡谷，一辆深绿色越野车从画面远处高速驶来，车顶绑着黑色行李箱和一只橙色救援包；驾驶员是一名戴护目镜的短发女性，副驾驶握着展开的折叠地图。无人机从公路侧前方约一米高的低空起幅，贴近地面快速逆向飞行，前景砂石和枯草高速掠过形成速度感；越野车接近后，无人机沿车头左侧快速横移，保持安全距离掠过车门和车顶行李，再顺势抬升到车后上方，最终以俯视全景展示车辆沿峡谷继续前进。镜头轨迹连续，低空段快速但稳定，靠近车辆时略微减速，越过主体后再次加速；车辆方向、人物位置、行李箱和救援包造型全程一致。不要穿过车体，不要碰撞地面，不要让车轮或人物变形，不要无理由翻滚镜头，不要跳切，不要字幕，不要水印。",
  },
  {
    id: "3d-space-transition",
    label: "3D 空间过渡转场",
    prompt: "4-6 秒连续空间转场镜头。第一空间是冷色调档案室，一名穿白衬衫的年轻男性站在金属桌前，右手拿着一枚刻花铜制怀表，桌面放着黑色档案盒和一张边缘烧焦的照片。镜头从人物侧面中景向怀表快速推进，进入怀表玻璃表面的圆形反光；反光扩展铺满画面后，摄影机沿同一运动方向穿过由齿轮、刻度和悬浮尘埃构成的短暂三维空间通道。通道中的圆形齿轮轮廓逐渐匹配第二空间的圆形车站时钟，摄影机从时钟玻璃中穿出，落到暖色调旧车站大厅。第二空间内同一人物保持相同站姿和手部动作，怀表仍在右手，黑色档案盒变为身旁长椅上的对应位置，最终镜头从时钟近景后拉到人物全景。转场必须利用圆形轮廓、光线方向、运动速度和道具位置完成空间连续，人物面容、服装、怀表造型与动作相位前后一致。不要凭空翻转空间，不要让人物复制或消失，不要让道具错位，不要出现传送门文字特效，不要字幕，不要水印。",
  },
  {
...
const CAMERA_MOTION_EFFECTS: Record<string, string> = {
  "low-push-reveal":
    "严格复现参考视频效果：从贴地道具特写起幅，沿走廊轴线低机位缓慢前推，道具退出前景后逐步抬镜揭示远处人物，最后落到人物近景；速度平稳克制，不跳切。",
  "flight-rush-to-closeup":
    "严格复现参考视频效果：从城市高楼群超远景起幅，摄影机在三维空间中沿直线快速飞行推进，连续跨越楼体间距并锁定高层平台人物，景别从超远景快速收束到人物面部特写，接近脸部前明显减速并稳定落幅。",
  "dual-subject-shuttle":
    "严格复现参考视频效果：两个相隔较远的表演主体交替成为画面中心，摄影机以快速横向甩镜在主体A与主体B之间多次摆渡；甩动中保留强运动模糊，到达每个主体时迅速制动并短暂看清动作，最后回到主体A，节奏由双方动作互相触发。",
  "drone-low-fast-pass":
    "严格复现参考视频效果：无人机保持接近地面的超低高度，贴着铺满落叶的林间通道持续高速直线前飞；落叶在下方形成强烈径向运动模糊，两侧树干高速后掠，中央消失点稳定，飞行高度和朝向基本不变，不抬升、不追踪车辆。",
  "3d-space-transition":
    "严格复现参考视频效果：第一空间从人物近景开始，镜头沿人物身体垂直向下俯冲并穿过桌沿或实体表面，表面铺满画面成为无缝遮挡；穿越后进入第二个完整三维室内空间，继续沿同一垂直轴线运动，再从上方向下落到第二空间人物面部近景，前后运动方向、中心位置和速度连续。",
  "lateral-foreground-wipe":
    "严格复现参考视频效果：摄影机与行走人物保持平行侧向跟拍，人物景别和画面位置基本稳定；路柱、树干或车辆边缘连续从近距离前景掠过并短暂遮住主体，利用完整遮挡形成自然转场，遮挡前后人物运动方向一致。",
  "half-orbit-pressure":
    "严格复现参考视频效果：从桌面关键道具与人物侧面中景起幅，摄影机围绕坐姿人物缓慢环绕约半圈并轻微向内推进，道具留在下方前景，人物由侧脸逐步转为正脸近景，背景横向位移形成压迫感。",
  "telephoto-compression-follow":
    "严格复现参考视频效果：长焦正面跟拍撑伞行走人物，摄影机与人物保持近似同步后退，使人物大小和中心位置稳定；道路栏杆、车灯和城市背景被长焦压缩并逐渐逼近主体，人物偶尔侧望但前进方向不变。",
  "top-down-descend-rotate":
    "严格复现参考视频效果：从庭院或大厅正上方高位俯拍全景起幅，摄影机缓慢下降并轻微旋转，逐步显露人物围绕中心道具的站位；最终越过一名人物肩部，落到肩后俯视中心人物与道具的过肩构图。",
  "handheld-refocus":
    "严格复现参考视频效果：从桌面手机与伸出的手指超近距离起幅，轻微手持贴近，焦点先停在手和手机，再随镜头靠近转移到人物紧张的脸；前景道具保持可见，景深由浅到稳定，不做大幅晃动。",
  "dolly-zoom-unease":
    "严格复现参考视频效果：人物居中正对镜头并手持照片，摄影机向前推进同时反向变焦，使人物大小相对稳定而走廊墙面向外拉伸、背景距离异常变化；最后停在人物惊觉的近景。",
  "reflection-to-reality":
    "严格复现参考视频效果：从雨夜水洼中的人物倒影和霓虹反光起幅，镜头贴近水面向前滑动并轻微抬升，倒影逐步离开画面，真实人物侧脸从画面边缘接管主体，最终落到人物手持小物件的侧脸近景。",
  "match-action-transition":
    "以同方向动作和相同画面位置完成剪辑衔接：前一空间的推门、抬手或转身动作在遮挡点切换，后一空间延续同一动作相位、运动方向和道具位置。",
  "static-frame-micro-motion":
    "先保持固定构图和近乎静止的环境，再让门缝、手指、信封或道具指示灯发生单一局部运动，最后仅做极慢幅度推近，靠微小变化制造注意力转移。",
};
...
- 用户选择的每条参考视频效果都是权威运动模板。必须严格复现其起幅景别、运动轴线、镜头高度、速度曲线、对焦变化、遮挡或转场触发点和落幅景别；只允许把示例中的人物、道具和场景替换成本次剧情素材，不能擅自改成另一种运镜。
- 不得只根据参考视频名称自由发挥，也不得把两条参考视频的运动机制混成一个镜头。每条参考视频应分配给最适合它的独立镜头或转场。
- 用户已经有对应运镜方式视频，不需要你生成参考视频 Prompt。
  ...
  const selectedCameraMotionText =
    referenceVideoCount > 0
      ? Array.from({ length: referenceVideoCount }, (_, index) => {
          ...
          const motion = selectedMotions[index % selectedMotions.length];
          return `参考视频${index + 1}：${motion.label}。${CAMERA_MOTION_EFFECTS[motion.id] || motion.prompt}`;
        }).join("；")
